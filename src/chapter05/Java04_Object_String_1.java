...
public class Java04_Object_String_1 {
    public static void main(String[] args) {
        ...
        //string 存在 string constant pool 優化 所以一樣的字符會指向同一個地址。用new建立的才會是新物件
        ...
        System.out.println(s == s2);//比較記憶體位置
        System.out.println(s.equals(s2));//比較內容 String 的equal 是預設比較內容
        //測試2 字串和int的各種 +
